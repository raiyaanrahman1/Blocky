...
class Block:
    ...
    def swap(self, direction: int) -> bool:
        ...
        if direction == 0:
            self.children = [children[1], children[0], children[3], children[2]]
        else:
            self.children = [children[3], children[2], children[1], children[0]]
        for i in range(4):
            self.children[i]._update_children_positions(pos[i])
    ...
    def rotate(self, direction: int) -> bool:
        ...
        pos = self._children_positions()
        if direction == 1:
            self.children = [children[1], children[2], children[3], children[0]]
        else:
            self.children = [children[3], children[0], children[1], children[2]]
        for i in range(4):
            self.children[i]._update_children_positions(pos[i])
    ...
    def combine(self) -> bool:
        ...
        for colour in colours:
            if colours[colour] == max(colours.values()):
                num += 1
                c = colour
